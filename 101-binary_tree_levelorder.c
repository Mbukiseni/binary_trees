...
/**
 * struct node_s - The singly linked list
...
/**
 * levels_rec - Calls function on all nodes at each level.
 ...
 * Return: Pointer to the head of linked list of children.
 */
ll *get_children(ll *head, const binary_tree_t *parent)
{
	if (parent->left)
...
/**
 * free_list - frees all the nodes in linked list
